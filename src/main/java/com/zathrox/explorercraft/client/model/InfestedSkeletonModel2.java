...
@OnlyIn(Dist.CLIENT)
public class InfestedSkeletonModel2<T extends MobEntity & IRangedAttackMob> extends BipedModel<T> {
    ...
    public InfestedSkeletonModel2() {
        this(0.0F, false);
    }

    public InfestedSkeletonModel2(float modelSize, boolean armoured) {
