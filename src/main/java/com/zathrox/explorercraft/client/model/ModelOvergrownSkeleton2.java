...
public class ModelOvergrownSkeleton2<T extends MobEntity & IRangedAttackMob> extends BipedModel<T> {
    ...
    public ModelOvergrownSkeleton2() {
        this(0.0F, false);
    }
    ...
    public ModelOvergrownSkeleton2(float modelSize, boolean armoured) {
        ...
        //- Head Inner
        this.bipedHeadInner = new RendererModel(this, 0, 32);
        ...
        this.bipedRightArmLayer.addBox(-1.0F, -2.0F, -1.0F, 2, 12, 2, 0.1f);
