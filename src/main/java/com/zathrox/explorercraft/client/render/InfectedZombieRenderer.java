...
public class InfectedZombieRenderer extends BipedRenderer<InfectedZombieEntity, InfectedZombieModel<InfectedZombieEntity>> {
   ...
   @Override
   protected void applyRotations(InfectedZombieEntity entityLiving, float ageInTicks, float rotationYaw, float partialTicks) {
    ...
    @Override
    protected ResourceLocation getEntityTexture(InfectedZombieEntity entity) {
