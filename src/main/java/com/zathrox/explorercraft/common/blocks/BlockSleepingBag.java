...
public class BlockSleepingBag extends BedBlock implements IBucketPickupHandler, ILiquidContainer
{
    ...
    public BlockSleepingBag(DyeColor colorIn, Block.Properties builder) {
