...
public class RiceBlock extends CropsBlock {
    ...
    public RiceBlock(Properties p_i48433_1_) {
        super(p_i48433_1_);
    }

    @OnlyIn(Dist.CLIENT)
    protected IItemProvider getSeedsItem() {
        return ExplorerItems.RICE;
    }

    public VoxelShape getShape(BlockState p_220053_1_, IBlockReader p_220053_2_, BlockPos p_220053_3_, ISelectionContext p_220053_4_) {
        return SHAPES[p_220053_1_.get(this.getAgeProperty())];
    }

    @Override
    public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
        return state.getBlock() == ExplorerBlocks.RICE_BASE;
    }
