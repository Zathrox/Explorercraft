...
public class OreGeneration {
    ...
    public static void setup()
    {
        for(Biome biome : ForgeRegistries.BIOMES)
        {
            ...
            if(OreGenConfig.spawnAmethyst.get())biome.addFeature(Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(Feature.ORE, new OreFeatureConfig(FillerBlockType.NATURAL_STONE, ExplorerBlocks.AMETHYST_ORE.getDefaultState(), 8), Placement.COUNT_RANGE, new CountRangeConfig(8, 5, 0, 40)));
            ...
            if(OreGenConfig.spawnJade.get() && biome == ExplorerBiomes.BAMBOO_FOREST) {
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(Feature.ORE, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, ExplorerBlocks.JADE_ORE.getDefaultState(), 10), Placement.COUNT_RANGE, new CountRangeConfig(5, 0, 0, 40)));
            }

            if(OreGenConfig.spawnRuby.get() && biome == ExplorerBiomes.FORESTED_MOUNTAIN) {
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(Feature.ORE, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, ExplorerBlocks.RUBY_ORE.getDefaultState(), 10), Placement.COUNT_RANGE, new CountRangeConfig(5, 0, 0, 50)));
