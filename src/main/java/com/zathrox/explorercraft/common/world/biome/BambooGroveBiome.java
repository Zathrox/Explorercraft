...
public class BambooGroveBiome extends Biome {
    ...
    public BambooGroveBiome(){
        ...
        this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(ExplorerFeature.BAMBOO_TREE.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).withChance(0.90F), ExplorerFeature.CHERRY_TREE.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).withChance(0.01F), ExplorerFeature.MAPLE_TREE.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).withChance(0.01F)), ExplorerFeature.BAMBOO_TREE.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG))).withPlacement(Placement.COUNT_EXTRA_HEIGHTMAP.configure(new AtSurfaceWithExtraConfig(30, 0.1F, 1))));
