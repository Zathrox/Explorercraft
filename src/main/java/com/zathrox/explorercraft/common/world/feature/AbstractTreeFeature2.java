...
public abstract class AbstractTreeFeature2 <T extends IFeatureConfig> extends Feature<T> {
    ...
    protected static boolean func_214587_a(IWorldGenerationBaseReader p_214587_0_, BlockPos p_214587_1_) {
        if (!(p_214587_0_ instanceof net.minecraft.world.IWorldReader)) // FORGE: Redirect to state method when possible
            return p_214587_0_.hasBlockState(p_214587_1_, (p_214573_0_) -> {
                ...
                return p_214573_0_.isAir() || p_214573_0_.isIn(BlockTags.LEAVES) || block == Blocks.GRASS_BLOCK || isDirt(block) || block.isIn(BlockTags.LOGS) || block.isIn(BlockTags.SAPLINGS) || block == Blocks.VINE;
            });
    ...
    protected static boolean isDirt(IWorldGenerationBaseReader worldIn, BlockPos pos) {
        return worldIn.hasBlockState(pos, (p_214590_0_) -> {
            return isDirt(p_214590_0_.getBlock());
        });
    }
    ...
    public AbstractTreeFeature2<T> setSapling(net.minecraftforge.common.IPlantable sapling) {
