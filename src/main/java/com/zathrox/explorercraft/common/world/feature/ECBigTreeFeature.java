...
public class ECBigTreeFeature extends AbstractTreeFeature2<NoFeatureConfig> {
    ...
    public ECBigTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
    ...
    private void makeFoliage(IWorldGenerationReader worldIn, int p_208525_2_, BlockPos pos, List<FoliageCoordinates> p_208525_4_, MutableBoundingBox p_208525_5_, Set<BlockPos> changedBlocks) {
        for (ECBigTreeFeature.FoliageCoordinates bigtreefeature$foliagecoordinates : p_208525_4_) {
    ...
    private void makeBranches(Set<BlockPos> p_208524_1_, IWorldGenerationReader p_208524_2_, int p_208524_3_, BlockPos p_208524_4_, List<ECBigTreeFeature.FoliageCoordinates> p_208524_5_, MutableBoundingBox p_208524_6_) {
        for (ECBigTreeFeature.FoliageCoordinates bigtreefeature$foliagecoordinates : p_208524_5_) {
    ...
    public boolean place(Set<BlockPos> changedBlocks, IWorldGenerationReader worldIn, Random rand, BlockPos position, MutableBoundingBox boundsIn) {
        ...
        if (i == -1) {
            ...
            int i1 = i - 5;
            List<ECBigTreeFeature.FoliageCoordinates> list = Lists.newArrayList();
            list.add(new ECBigTreeFeature.FoliageCoordinates(position.up(i1), l));
                    ...
                    for (int j1 = 0; j1 < k; ++j1) {
                        ...
                        if (this.makeLimb(changedBlocks, worldIn, blockpos, blockpos1, false, boundsIn) == -1) {
                            ...
                            if (this.makeLimb(changedBlocks, worldIn, blockpos2, blockpos, false, boundsIn) == -1) {
                                list.add(new ECBigTreeFeature.FoliageCoordinates(blockpos, blockpos2.getY()));
                            }
                        }
                    }
                }
