...
public class ECTreeFeature extends AbstractTreeFeature2<NoFeatureConfig> {
    ...
    public ECTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
        this(configFactoryIn, 4, DEFAULT_TRUNK, DEFAULT_LEAF, false);
    }

    public ECTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn, int minTreeHeightIn, BlockState trunkState, BlockState leafState, boolean vinesGrowIn) {
