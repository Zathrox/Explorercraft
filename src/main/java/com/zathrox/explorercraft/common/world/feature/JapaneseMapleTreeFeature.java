...
public class JapaneseMapleTreeFeature extends AbstractTreeFeature2<NoFeatureConfig> {
    ...
    public JapaneseMapleTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i51443_1_) {
        super(p_i51443_1_);
    }
