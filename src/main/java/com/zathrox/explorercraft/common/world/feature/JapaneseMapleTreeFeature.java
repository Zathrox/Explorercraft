...
public class JapaneseMapleTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {

    private static final BlockState TRUNK = ExplorerBlocks.MAPLE_LOG.getDefaultState();
    private static final BlockState LEAF = ExplorerBlocks.MAPLE_LEAVES.getDefaultState();

    public JapaneseMapleTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i51443_1_, boolean p_i51443_2_) {
