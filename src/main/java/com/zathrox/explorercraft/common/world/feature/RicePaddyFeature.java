...
public class RicePaddyFeature extends Feature<NoFeatureConfig> {
    ...
    private static final BlockState base = ExplorerBlocks.RICE_BASE.getDefaultState();
        ...
        else
        {
                    ...
                    for (int i4 = 0; i4 < 5; ++i4) {
                        ...
                        if (aboolean[(l1 * 16 + i3) * 8 + i4]) {
                            ...
                            if (i4 >= 4) {
                                ...
                                if (world.getBlockState(target) != ExplorerBlocks.RICE_TOP.getDefaultState() && world.getBlockState(target) != base && world.getBlockState(target) != ExplorerBlocks.BAMBOO_LOG.getDefaultState()) {
                            ...
                            } else if (world.getBlockState(target.up()).getBlock() == ExplorerBlocks.BAMBOO_LOG && isSoil ) {
            ...
            while (riceCount <= riceMax && possibles.size() > 0) {
                ...
                if (world.canBlockSeeSky(rice.up()) && world.isAirBlock(rice.up())) {
                    ...
                    BlockState top = ExplorerBlocks.RICE_TOP.getDefaultState().with(RiceBlock.AGE, 0 + randomAge.nextInt(6));
