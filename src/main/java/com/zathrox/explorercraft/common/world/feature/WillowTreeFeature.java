...
public class WillowTreeFeature extends AbstractTreeFeature2<NoFeatureConfig> {
    ...
    public WillowTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
    ...
    private boolean checkBiome(IWorld world, BlockPos pos) {
        return world.getBiome(pos) == ExplorerBiomes.FUNGAL_FOREST.get();
    }
    /**
