...
import com.zathrox.explorercraft.core.util.ExplorerVillagerUtil;
...
public class CommonProxy {
    ...
    void changeVanillaFields() {
        ...
        addVillagerTrades(VillagerProfession.FARMER,  ExplorerVillagerUtil.newTradeMap(ImmutableMap.of(1, new VillagerTrades.ITrade[] {
        ...
        addVillagerTrades(VillagerProfession.BUTCHER,  ExplorerVillagerUtil.newTradeMap(ImmutableMap.of(3, new VillagerTrades.ITrade[] {
