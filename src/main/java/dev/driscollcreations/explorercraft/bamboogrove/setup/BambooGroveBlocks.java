...
public class BambooGroveBlocks {
    ...
    public static final RegistryObject<BambooLogBlock> BAMBOO_LOG = BlockUtils.register("bamboo_log",
            () -> new BambooLogBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(2, 10).sound(SoundType.BAMBOO)));
    ...
    public static final RegistryObject<Block> BAMBOO_SAPLING = BlockUtils.register("bamboo_sapling",
            () -> new SaplingBlock(new BambooTree(), BlockBehaviour.Properties.of(Material.PLANT).noCollission().randomTicks().instabreak().sound(SoundType.GRASS)));
    public static final RegistryObject<Block> POTTED_BAMBOO_SAPLING = BlockUtils.registerNoItem("potted_bamboo_sapling",
            () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, BAMBOO_SAPLING::get, BlockBehaviour.Properties.of(Material.DECORATION).instabreak()));
    ...
    public static final RegistryObject<Block> BAMBOO_STAIRS = BlockUtils.register("bamboo_stairs",
            () -> new StairBlock(() -> BAMBOO_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(BAMBOO_PLANKS.get())));
    ...
    public static final RegistryObject<ExplorerSigns.CustomStandingSignBlock> BAMBOO_STANDING_SIGN = BlockUtils.registerNoItem("bamboo_sign", () -> new ExplorerSigns.CustomStandingSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD), BAMBOO_WOODTYPE));
    public static final RegistryObject<ExplorerSigns.CustomWallSignBlock> BAMBOO_WALL_SIGN = BlockUtils.registerNoItem("bamboo_wall_sign", () -> new ExplorerSigns.CustomWallSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD), BAMBOO_WOODTYPE));
    ...
    public static final RegistryObject<Block> CHERRY_SAPLING = BlockUtils.register("cherry_sapling",
            () -> new SaplingBlock(new CherryTree(), BlockBehaviour.Properties.of(Material.PLANT).noCollission().randomTicks().instabreak().sound(SoundType.GRASS)));
    public static final RegistryObject<Block> POTTED_CHERRY_SAPLING = BlockUtils.registerNoItem("potted_cherry_sapling",
            () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, CHERRY_SAPLING::get, BlockBehaviour.Properties.of(Material.DECORATION).instabreak()));
    ...
    public static final RegistryObject<Block> CHERRY_STAIRS = BlockUtils.register("cherry_stairs",
            () -> new StairBlock(() -> CHERRY_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(CHERRY_PLANKS.get())));
    ...
    public static final RegistryObject<ExplorerSigns.CustomStandingSignBlock> CHERRY_STANDING_SIGN = BlockUtils.registerNoItem("cherry_sign", () -> new ExplorerSigns.CustomStandingSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD), CHERRY_WOODTYPE));
    public static final RegistryObject<ExplorerSigns.CustomWallSignBlock> CHERRY_WALL_SIGN = BlockUtils.registerNoItem("cherry_wall_sign", () -> new ExplorerSigns.CustomWallSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD), CHERRY_WOODTYPE));
    ...
    public static final RegistryObject<Block> CHERRY_BLOSSOM_STAIRS = BlockUtils.register("cherry_blossom_stairs",
            () -> new StairBlock(() -> CHERRY_BLOSSOM_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(CHERRY_BLOSSOM_PLANKS.get())));
    ...
    public static final RegistryObject<ExplorerSigns.CustomStandingSignBlock> CHERRY_BLOSSOM_STANDING_SIGN = BlockUtils.registerNoItem("cherry_blossom_sign", () -> new ExplorerSigns.CustomStandingSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD), CHERRY_BLOSSOM_WOODTYPE));
    public static final RegistryObject<ExplorerSigns.CustomWallSignBlock> CHERRY_BLOSSOM_WALL_SIGN = BlockUtils.registerNoItem("cherry_blossom_wall_sign", () -> new ExplorerSigns.CustomWallSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD), CHERRY_BLOSSOM_WOODTYPE));
    ...
    public static final RegistryObject<Block> MAPLE_SAPLING = BlockUtils.register("maple_sapling",
            () -> new SaplingBlock(new MapleTree(), BlockBehaviour.Properties.of(Material.PLANT).noCollission().randomTicks().instabreak().sound(SoundType.GRASS)));
    public static final RegistryObject<Block> POTTED_MAPLE_SAPLING = BlockUtils.registerNoItem("potted_maple_sapling",
            () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, MAPLE_SAPLING::get, BlockBehaviour.Properties.of(Material.DECORATION).instabreak()));
    ...
    public static final RegistryObject<Block> MAPLE_STAIRS = BlockUtils.register("maple_stairs",
            () -> new StairBlock(() -> MAPLE_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(MAPLE_PLANKS.get())));
    ...
    public static final RegistryObject<RotatedPillarBlock> MAPLE_STRIPPED_WOOD = BlockUtils.register("maple_stripped_wood",
            () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(2, 10).sound(SoundType.WOOD)));
    public static final RegistryObject<ExplorerSigns.CustomStandingSignBlock> MAPLE_STANDING_SIGN = BlockUtils.registerNoItem("maple_sign", () -> new ExplorerSigns.CustomStandingSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD), MAPLE_WOODTYPE));
    public static final RegistryObject<ExplorerSigns.CustomWallSignBlock> MAPLE_WALL_SIGN = BlockUtils.registerNoItem("maple_wall_sign", () -> new ExplorerSigns.CustomWallSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD), MAPLE_WOODTYPE));

    //== Rice, Jade
    public static final RegistryObject<Block> JADE_ORE = BlockUtils.register("jade_ore", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(3, 10).requiresCorrectToolForDrops().sound(SoundType.STONE)));
    public static final RegistryObject<Block> JADE_BLOCK = BlockUtils.register("jade_block", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(3, 10).sound(SoundType.METAL)));

    public static final RegistryObject<Block> TATAMI = BlockUtils.register("tatami", () -> new TatamiBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(0.2F, 0.3F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> TATAMI_HALF = BlockUtils.register("tatami_half", () -> new TatamiHalfBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(0.2F, 0.3F).sound(SoundType.WOOD)));

    public static final RegistryObject<Block> RICE_STRAW_BLOCK = BlockUtils.register("rice_straw_block", () -> new HayBlock(BlockBehaviour.Properties.of(Material.GRASS, MaterialColor.COLOR_YELLOW).strength(0.5F).sound(SoundType.GRASS)));
    public static final RegistryObject<Block> RICE_BASE = BlockUtils.registerNoItem("rice_base", () -> new RiceBaseBlock(BlockBehaviour.Properties.of(Material.WATER_PLANT).noCollission().sound(SoundType.WET_GRASS)));
    public static final RegistryObject<Block> RICE_TOP = BlockUtils.registerNoItem("rice_top", () -> new RiceBlock(BlockBehaviour.Properties.of(Material.PLANT).noCollission().randomTicks().sound(SoundType.WET_GRASS)));
