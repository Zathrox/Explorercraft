...
//
//public class SakuraTreeStructure extends Structure<NoneFeatureConfiguration>
//
//    {
//    public SakuraTreeStructure(Codec<NoneFeatureConfiguration> codec) {
//        super(codec);
//    }
//
//    /**
...
//                    new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY).get(new ResourceLocation(Explorercraft.MOD_ID, "sakura_tree")), 1),
