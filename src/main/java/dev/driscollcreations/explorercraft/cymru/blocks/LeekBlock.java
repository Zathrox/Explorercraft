...
public class LeekBlock extends CropBlock {
    ...
    public LeekBlock(BlockBehaviour.Properties props) {
        super(props);
    }

    protected ItemLike getBaseSeedId() {
        return CymruItems.LEEK.get();
    }

    public VoxelShape getShape(BlockState blockState, BlockGetter iBlockReader, BlockPos pos, CollisionContext selectionContext) {
