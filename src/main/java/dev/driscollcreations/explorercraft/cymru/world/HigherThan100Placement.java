...
public class HigherThan100Placement extends FeatureDecorator<HeightmapConfiguration> {
    public HigherThan100Placement(Codec<HeightmapConfiguration> p_70747_) {
        super(p_70747_);
    }
