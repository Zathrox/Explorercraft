...
/**
        ...
        public void init(ChunkGenerator<?> chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn){
            ...
            if (maxHeight - minHeight < 2 && maxHeight - minHeight > -2) {
                ...
                com.zathrox.explorercraft.common.world.feature.structure.WizardTowerPieces.createPieces(templateManagerIn, blockpos, rotation, this.components, this.rand); //create the layout of structure
