...
public class ExplorerFoods {
    ...
    //---- Cymru Expansion
    public static final Food CAWL_STEW = buildStew(20);
    ...
    public static final Food LEEK_STEW = buildStew(8);
    public static final Food WELSH_CAKES = (new Food.Builder()).nutrition(4).saturationMod(0.3F).fast().build();
    public static final Food WELSH_RAREBIT = (new Food.Builder()).nutrition(8).saturationMod(0.6F).build();
    ...
    private static Food buildStew(int hungerValue) {
        return (new Food.Builder()).nutrition(hungerValue).saturationMod(2.0F).build();
    }
}
