...
public class ExplorerSpawnEggItem  extends SpawnEggItem {
    protected static final List<ExplorerSpawnEggItem> UNADDED_EGGS = new ArrayList<>();
    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    public ExplorerSpawnEggItem(final RegistryObject<? extends EntityType<?>> entityTypeSupplier,
