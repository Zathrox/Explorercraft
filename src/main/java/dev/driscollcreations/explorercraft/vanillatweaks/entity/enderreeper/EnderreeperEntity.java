...
//
//    //==== Spawning ====//
//    /*public static boolean spawnEnderreeper(EntityType<? extends MonsterEntity> type, LevelAccessor worldIn, SpawnReason reason, BlockPos pos, Random randomIn) {
...
//            biome.getSpawns(MobCategory.MONSTER).add(new Biome.SpawnListEntry(ExplorerEntities.ENDERREEPER, 1, 1, 1));
//        }
//
//    }*/
//
...
//        return Math.lerp(partialTicks, (float) this.lastActiveTime, (float) this.timeSinceIgnited) / (float) (this.fuseTime - 2);
//    }
//
//    //===== Sounds =====//
...
//            super(enderreeper, Player.class, false);
...
//                return enderreeper.shouldAttackPlayer((Player) p_220790_1_);
//            });
//        }
//
//        /**
