...
public class EnderreeperModel<T extends Entity> extends EntityModel<T> {
    ...
    public void setupAnim(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        backForeRightLeg.xRot += MathHelper.cos(limbSwing * 0.6662F + 3.141593F) * 1.4F * limbSwingAmount;
        ...
        foreFrontRightLeg.xRot -= MathHelper.cos(limbSwing * 0.6662F + 3.141593F) * 1.4F * limbSwingAmount;
        frontLeftLeg.xRot = -0.8726646F;
        frontLeftLeg.xRot += MathHelper.cos(limbSwing * 0.6662F + 3.141593F) * 1.4F * limbSwingAmount;
        foreFrontLeftLeg.xRot = 0.1745329F;
        foreFrontLeftLeg.xRot -= MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
        backLeftLeg.xRot = 0.8726646F;
        backLeftLeg.xRot -= MathHelper.cos(limbSwing * 0.6662F + 3.141593F) * 1.4F * limbSwingAmount;
        backForeLeftLeg.xRot = -0.1745329F;
        backForeLeftLeg.xRot += MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
    }
