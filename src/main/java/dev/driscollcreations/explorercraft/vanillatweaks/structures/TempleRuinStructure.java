//package dev.driscollcreations.explorercraft.vanillatweaks.structures;
//
...
//
//public class TempleRuinStructure extends Structure<NoneFeatureConfiguration>
//
//    {
//    public TempleRuinStructure(Codec<NoneFeatureConfiguration> codec) {
//        super(codec);
//    }
//
//    /**
...
//        return TempleRuinStructure.Start::new;
//    }
//
//
//    /**
...
//                                                    .get(new ResourceLocation(Explorercraft.MOD_ID, "temple_ruin")),
//
...
//            Explorercraft.LOGGER.log(Level.DEBUG, "Temple ruins at " +
